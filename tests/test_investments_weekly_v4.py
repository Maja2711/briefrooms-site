...
class MultiInstrumentExposureTests(unittest.TestCase):
    ...
    def test_inverse_is_really_opposite(self):
        fresh = {"direction": "short", "score": -42,
    ...
    def test_negative_short_does_not_prove_inverse(self):
        candidates = {"base_v2": {"direction": "short", "raw_score": -60, "conviction": 9},
                      "inverse_v2": {"direction": "long", "raw_score": 60, "conviction": 9}}
        learning = {"methods": {"base_v2": {"count": 10, "adjustment": -3},
                                "inverse_v2": {"count": 0, "adjustment": 0}}}
        policy = {"strategy_tournament": {"candidate_methods": ["base_v2", "inverse_v2"],
    ...
    def test_v5_policy_does_not_force_continuous_exposure(self):
        ...
        self.assertFalse(policy.get("reentry_after_any_close"))
