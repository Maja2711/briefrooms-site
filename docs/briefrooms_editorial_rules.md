...
Klasyfikacja pasma jest **semantyczna**, a nie wyłącznie odziedziczona po dziale źródła: materiał biznesowy o sankcjach, wojnie lub porozumieniu międzynarodowym może zostać sklasyfikowany jako geopolityka, a materiał z działu nauki dotyczący chorób, terapii lub zdrowia — jako zdrowie. Po odrzuceniu karty przez limit 72h, brak zdjęcia albo inny guard system ponownie stosuje kolejność pasm i limity do faktycznie publikowanej dwunastki; każde wolne miejsce jest uzupełniane ponownie według kolejności **polityka → geopolityka → ekonomia → AI / technologie AI → nauka → zdrowie → sport**, a nie według technicznej kolejności rezerwy. Rezerwa nie może zniekształcić końcowej polityki redakcyjnej.
