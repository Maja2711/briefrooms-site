...
def _outcome_block(payload: Mapping[str, Any], occurred_at: str) -> dict[str, Any]:
    ...
    return {
        ...
        "entry_at": _first(payload, "entry_at", "entered_at", "opened_at", "entry_time"),
        "exit_at": _first(payload, "exit_at", "exited_at", "closed_at", "exit_time"),
        ...
        "turnover_fraction": _first(payload, "turnover_fraction"),
