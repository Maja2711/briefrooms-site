...
body[data-page="news"] .section-tabs{position:sticky!important;top:calc(var(--br-site-header-height, 84px) + 8px)!important;z-index:20!important;display:flex!important;gap:8px!important;justify-content:flex-start!important;align-items:center!important;flex-wrap:wrap!important;margin:18px auto 30px!important;padding:8px!important;max-width:1180px!important;border:1px solid rgba(172,224,240,.20)!important;border-radius:16px!important;background:linear-gradient(145deg,rgba(14,38,57,.94),rgba(5,18,31,.94))!important;box-shadow:0 16px 38px rgba(0,0,0,.28),inset 0 1px 0 rgba(255,255,255,.08)!important;backdrop-filter:blur(16px)!important}
...
body[data-page="news"] section.card{scroll-margin-top:calc(var(--br-site-header-height, 84px) + 92px)!important}
