(function () {
  ...
  function addEnglishDoorStyles() {
    ...
    var css = `
      ...
      .rooms .room-door h3{display:block!important;font-size:18px!important;line-height:1.1!important;font-weight:900!important;letter-spacing:-.02em!important;color:#f4fbff!important;text-shadow:0 2px 18px rgba(0,0,0,.55),0 0 8px rgba(255,255,255,.10)!important;margin:0 0 10px!important}
      .rooms .room-door small{display:inline-flex!important;align-items:center!important;justify-content:center!important;padding:5px 10px!important;border-radius:999px!important;font-size:11px!important;line-height:1!important;font-weight:900!important;background:rgba(255,255,255,.13)!important;border:1px solid rgba(255,255,255,.16)!important;box-shadow:inset 0 1px 0 rgba(255,255,255,.18)!important;margin:0 0 12px!important;color:inherit!important}
      .rooms .room-door p{display:block!important;min-height:40px!important;font-size:12px!important;line-height:1.35!important;color:#d6e5f1!important;margin:0 0 12px!important}
      ...
      .rooms .room-door:nth-child(1),.rooms .room-door:nth-child(1) .room-icon,.rooms .room-door:nth-child(1) small,.rooms .room-door:nth-child(1) .open{color:#63fff4!important}
      .rooms .room-door:nth-child(2),.rooms .room-door:nth-child(2) .room-icon,.rooms .room-door:nth-child(2) small,.rooms .room-door:nth-child(2) .open{color:#ffd15e!important}
      .rooms .room-door:nth-child(3),.rooms .room-door:nth-child(3) .room-icon,.rooms .room-door:nth-child(3) small,.rooms .room-door:nth-child(3) .open{color:#86ffb7!important}
      .rooms .room-door:nth-child(4),.rooms .room-door:nth-child(4) .room-icon,.rooms .room-door:nth-child(4) small,.rooms .room-door:nth-child(4) .open{color:#7fc8ff!important}
      .rooms .room-door:nth-child(5),.rooms .room-door:nth-child(5) .room-icon,.rooms .room-door:nth-child(5) small,.rooms .room-door:nth-child(5) .open{color:#e1a2ff!important}
      .rooms .room-door:nth-child(1) .portal{box-shadow:inset 0 1px 0 rgba(255,255,255,.28),inset 0 0 0 2px rgba(255,255,255,.06),inset 0 -10px 20px rgba(0,0,0,.08),0 22px 48px rgba(0,0,0,.34),0 0 18px rgba(99,255,244,.26),0 0 44px rgba(99,255,244,.44),0 0 72px rgba(99,255,244,.18)!important}
      .rooms .room-door:nth-child(2) .portal{box-shadow:inset 0 1px 0 rgba(255,255,255,.28),inset 0 0 0 2px rgba(255,255,255,.06),inset 0 -10px 20px rgba(0,0,0,.08),0 22px 48px rgba(0,0,0,.34),0 0 18px rgba(255,209,94,.26),0 0 44px rgba(255,209,94,.44),0 0 72px rgba(255,209,94,.18)!important}
      .rooms .room-door:nth-child(3) .portal{box-shadow:inset 0 1px 0 rgba(255,255,255,.28),inset 0 0 0 2px rgba(255,255,255,.06),inset 0 -10px 20px rgba(0,0,0,.08),0 22px 48px rgba(0,0,0,.34),0 0 18px rgba(134,255,183,.26),0 0 44px rgba(134,255,183,.44),0 0 72px rgba(134,255,183,.18)!important}
      .rooms .room-door:nth-child(4) .portal{box-shadow:inset 0 1px 0 rgba(255,255,255,.28),inset 0 0 0 2px rgba(255,255,255,.06),inset 0 -10px 20px rgba(0,0,0,.08),0 22px 48px rgba(0,0,0,.34),0 0 18px rgba(127,200,255,.26),0 0 44px rgba(127,200,255,.44),0 0 72px rgba(127,200,255,.18)!important}
      .rooms .room-door:nth-child(5) .portal{box-shadow:inset 0 1px 0 rgba(255,255,255,.28),inset 0 0 0 2px rgba(255,255,255,.06),inset 0 -10px 20px rgba(0,0,0,.08),0 22px 48px rgba(0,0,0,.34),0 0 18px rgba(225,162,255,.28),0 0 46px rgba(225,162,255,.46),0 0 76px rgba(225,162,255,.20)!important}
