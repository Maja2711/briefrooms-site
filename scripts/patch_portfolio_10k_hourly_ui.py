...
EXPLAINERS_JS = '<script src="/scripts/portfolio-10k-explainers.js?v=3" defer></script>'
...
for path in PAGES:
    ...
    text = re.sub(r'/scripts/portfolio-10k-explainers\.js\?v=\d+', '/scripts/portfolio-10k-explainers.js?v=3', text)
