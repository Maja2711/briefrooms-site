...
ASSET_VERSION = "weekly-20"
POSITION_STATE_VERSION = "20260910-2"
BROWSER_LIVE_VERSION = "20260915-3"
PUBLIC_BRAND_VERSION = "1"
...
PAGES = {
    ROOT / "pl/inwestycje/pozycje-tygodniowe.html": {
        ...
        "weekly_label": "Weekly Trading",
        "stock_label": "Stock Trading",
...
def shell_week_id() -> str:
    now = datetime.now(TZ)
    # Keep Friday/Saturday on the current week. The next trading week becomes
    # the public target on Sunday, when the governed forecast is actually due.
    if now.weekday() == 6:
